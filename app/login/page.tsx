      ...
      <div className="relative z-10 grid md:grid-cols-2 min-h-screen">
        ...
        <div className="hidden md:flex flex-col justify-center px-20">
          ...
          <p className="text-gray-300 text-lg mb-12 leading-relaxed">
            Continue building scalable real-time systems powered by Go,
            concurrency engineering, and WebSocket architecture.
          </p>
          ...
          <div className="space-y-8">
            <Feature
              ...
              desc="Concurrent message fan-out with isolated room goroutines."
            />
            <Feature
              color="blue"
              title="Private Messaging"
              desc="In-memory conversation tracking with real-time delivery."
            />
            <Feature
              color="indigo"
              title="Production Ready"
              desc="Graceful shutdown, race-free concurrency, scalable design."
            />
          </div>
        </div>
              ...
              <>
                ...
                <div className="space-y-4">
                  <button
                    ...
                    hover:opacity-90 py-3 rounded-xl transition 
                  ...
                  <button
                    ...
                    className="w-full border border-red-500 text-red-400 
                    hover:bg-red-500/10 py-3 rounded-xl transition 
                    cursor-pointer active:scale-95"
                  >
                    Logout
                  </button>
